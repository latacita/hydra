...
Una restricción es una expresión boolean que se evalúa a vedadero o falso, y que contendrá un operador, representando por la clase \emph{BoolOperand}, y varios operadores, representados por diversas clases. 

Un operador puede ser tanto una \emph{SimpleFeature}, es decir, una feature no clonable, como 
