...
% Capítulo 4: Creación de la sintaxis abstracta
\input{metamodelo/metamodelo.tex}

% Capítulo 5: Creacion de la gramatica
\input{gramatica/raiz.tex}

% Capítulo 6: Validacion de las sintaxis concretas
\input{emfvf/raiz.tex}

% Capítulo 7: Creacion de la semantica
\input{semantica/raiz.tex}

% Capítulo 8: Discusión, Conclusiones y Trabajos Futuros
