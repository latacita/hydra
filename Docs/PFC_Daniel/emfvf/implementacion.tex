...
\begin{enumerate}
    \item La ruta que indica donde está el árbol de características al que se
        aplican las restricciones definidas es correcta. Ello implica comprobar tanto que la ruta es correcta como que el fichero que se halla en dicha ruta corresponde de verdad a un árbol de características.
