...
A continuación, de acuerdo con los expuesto en la sección anterior, procedimos a definir la las restricciones externas que no podían ser definidas en Ecore (Figura~\ref{fig:planning}-\emph{T3}). Dichas restricciones se implementaron utilizando la facilidad de EMF denominada EMF Validation Framework~\cite{}.
