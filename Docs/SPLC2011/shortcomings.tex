...
The reader could argue a Domain-Specific Language (DSL) or Ecore-based model would be more useful for this case study than a feature model. We will skip this question at this moment and we will come back to it in the discussion section.
