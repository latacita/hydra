 ...
 * <ul>
 *   <li>{@link syntax.impl.UnaryOpImpl#getUnaryOp <em>Unary Op</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class UnaryOpImpl extends LogicalOperatorImpl implements UnaryOp {
	...
	protected EClass eStaticClass() {
		return SyntaxPackage.Literals.UNARY_OP;
	}
	...
	public NotificationChain basicSetUnaryOp(BoolPriorityOperand2 newUnaryOp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.UNARY_OP__UNARY_OP, oldUnaryOp, newUnaryOp);
	...
	public void setUnaryOp(BoolPriorityOperand2 newUnaryOp) {
		if (newUnaryOp != unaryOp) {
			...
			if (unaryOp != null)
				msgs = ((InternalEObject)unaryOp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.UNARY_OP__UNARY_OP, null, msgs);
			if (newUnaryOp != null)
				msgs = ((InternalEObject)newUnaryOp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.UNARY_OP__UNARY_OP, null, msgs);
			msgs = basicSetUnaryOp(newUnaryOp, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.UNARY_OP__UNARY_OP, newUnaryOp, newUnaryOp));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SyntaxPackage.UNARY_OP__UNARY_OP:
