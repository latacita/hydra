 ...
 * <ul>
 *   <li>{@link syntax.impl.NumOperatorImpl#getNumOp1 <em>Num Op1</em>}</li>
 *   <li>{@link syntax.impl.NumOperatorImpl#getNumOp2 <em>Num Op2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NumOperatorImpl extends NumOperandImpl implements NumOperator {
	...
	protected EClass eStaticClass() {
		return SyntaxPackage.Literals.NUM_OPERATOR;
	}
	...
	public NotificationChain basicSetNumOp1(NumPriorityOperand1 newNumOp1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.NUM_OPERATOR__NUM_OP1, oldNumOp1, newNumOp1);
	...
	public void setNumOp1(NumPriorityOperand1 newNumOp1) {
		if (newNumOp1 != numOp1) {
			...
			if (numOp1 != null)
				msgs = ((InternalEObject)numOp1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.NUM_OPERATOR__NUM_OP1, null, msgs);
			if (newNumOp1 != null)
				msgs = ((InternalEObject)newNumOp1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.NUM_OPERATOR__NUM_OP1, null, msgs);
			msgs = basicSetNumOp1(newNumOp1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.NUM_OPERATOR__NUM_OP1, newNumOp1, newNumOp1));
	}
	...
	public NotificationChain basicSetNumOp2(NumPriorityOperand2 newNumOp2, NotificationChain msgs) {
		...
		numOp2 = newNumOp2;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.NUM_OPERATOR__NUM_OP2, oldNumOp2, newNumOp2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNumOp2(NumPriorityOperand2 newNumOp2) {
		if (newNumOp2 != numOp2) {
			NotificationChain msgs = null;
			if (numOp2 != null)
				msgs = ((InternalEObject)numOp2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.NUM_OPERATOR__NUM_OP2, null, msgs);
			if (newNumOp2 != null)
				msgs = ((InternalEObject)newNumOp2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.NUM_OPERATOR__NUM_OP2, null, msgs);
			msgs = basicSetNumOp2(newNumOp2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.NUM_OPERATOR__NUM_OP2, newNumOp2, newNumOp2));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SyntaxPackage.NUM_OPERATOR__NUM_OP1:
				return basicSetNumOp1(null, msgs);
			case SyntaxPackage.NUM_OPERATOR__NUM_OP2:
