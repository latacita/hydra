 ...
 */
public class ConstraintBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final syntax.resource.constraint.IConstraintTextResource resource, final syntax.resource.constraint.ui.ConstraintEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final syntax.resource.constraint.IConstraintTextResource resource, final syntax.resource.constraint.ui.ConstraintEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final syntax.resource.constraint.IConstraintTextResource resource, final syntax.resource.constraint.ui.ConstraintEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
