 ...
 * @generated
 */
public abstract class SpecializationmodelAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = specializationModel.diagram.part.SpecializationmodelDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected SpecializationmodelAbstractExpression(String body,
			EClassifier context) {
		myBody = body;
		myContext = context;
	}
