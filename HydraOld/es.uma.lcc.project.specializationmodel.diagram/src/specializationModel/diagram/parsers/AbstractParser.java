package specializationModel.diagram.parsers;
			...
			if (Boolean.TYPE.equals(iClass)) {
				if (value instanceof Boolean) {
					...
					value = new InvalidValue(
							NLS
									.bind(
											specializationModel.diagram.part.Messages.AbstractParser_UnexpectedValueTypeMessage,
											iClass.getName()));
				}
					...
					if (s.length() == 0) {
						...
						try {
							...
							value = new InvalidValue(
									NLS
											.bind(
													specializationModel.diagram.part.Messages.AbstractParser_WrongStringConversionMessage,
													iClass.getName()));
						}
					}
				} else {
				...
				if (value instanceof String) {
					...
					if (literal == null) {
						value = new InvalidValue(
								NLS
										.bind(
												specializationModel.diagram.part.Messages.AbstractParser_UnknownLiteralMessage,
												value));
					} else {
