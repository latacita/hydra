...
public class TestPackageImpl extends EPackageImpl implements TestPackage {
	...
	public void initializePackageContents() {
		...
		EOperation op = addEOperation(personEClass, ecorePackage.getEBoolean(), "isAgeValid", 1, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "diag", 1, 1, IS_UNIQUE, IS_ORDERED);
		EGenericType g1 = createEGenericType(ecorePackage.getEMap());
		EGenericType g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		g2 = createEGenericType();
		g1.getETypeArguments().add(g2);
		addEParameter(op, g1, "map", 1, 1, IS_UNIQUE, IS_ORDERED);
