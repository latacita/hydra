 ...
 * hovers, is a proxy.
 */
public class HydraConstHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public HydraConstHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (hydraconstraints.resource.hydraConst.IHydraConstTextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new hydraconstraints.resource.hydraConst.ui.HydraConstHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
