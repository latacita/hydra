 ...
 */
public class HydraConstPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(hydraconstraints.resource.hydraConst.ui.HydraConstUIPlugin.getDefault().getPreferenceStore());
		setDescription("HydraConst Text Editor Preferences");
	}
