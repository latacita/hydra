 ...
 */
public class HydraConstImageProvider {
	
	public final static HydraConstImageProvider INSTANCE = new HydraConstImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(hydraconstraints.resource.hydraConst.ui.HydraConstUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				hydraconstraints.resource.hydraConst.ui.HydraConstUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
