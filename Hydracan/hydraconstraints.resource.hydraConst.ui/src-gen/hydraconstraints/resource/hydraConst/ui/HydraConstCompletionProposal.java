 ...
 */
public class HydraConstCompletionProposal implements java.lang.Comparable<HydraConstCompletionProposal> {
	...
	public HydraConstCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public HydraConstCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public HydraConstCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof HydraConstCompletionProposal) {
			HydraConstCompletionProposal other = (HydraConstCompletionProposal) object;
	...
	public int compareTo(HydraConstCompletionProposal object) {
		if (object instanceof HydraConstCompletionProposal) {
			HydraConstCompletionProposal other = (HydraConstCompletionProposal) object;
