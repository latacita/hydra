 ...
 * @since 3.2
 */
public class HydraConstBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput fInput;
	 ...
	 */
	public HydraConstBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public HydraConstBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public HydraConstBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput);
		...
		fInput= (hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput) input;
		...
		hydraconstraints.resource.hydraConst.ui.HydraConstHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = hydraconstraints.resource.hydraConst.ui.HydraConstHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput getInput() {
		return fInput;
	}
