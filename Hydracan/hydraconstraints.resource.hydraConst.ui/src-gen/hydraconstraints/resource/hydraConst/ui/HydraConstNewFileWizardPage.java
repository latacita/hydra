 ...
 */
public class HydraConstNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public HydraConstNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new hydraConst file");
