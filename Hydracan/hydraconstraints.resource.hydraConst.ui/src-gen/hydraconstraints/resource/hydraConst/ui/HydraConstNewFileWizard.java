...
public class HydraConstNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private hydraconstraints.resource.hydraConst.ui.HydraConstNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public HydraConstNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new hydraconstraints.resource.hydraConst.ui.HydraConstNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			hydraconstraints.resource.hydraConst.ui.HydraConstUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			hydraconstraints.resource.hydraConst.ui.HydraConstUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation().getSyntaxName();
	}
