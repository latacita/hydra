 ...
 * olInput</code>.
 */
public class HydraConstDocBrowserInformationControlInput {
	
	private final HydraConstDocBrowserInformationControlInput fPrevious;
	private HydraConstDocBrowserInformationControlInput fNext;
	 ...
	 */
	public HydraConstDocBrowserInformationControlInput(HydraConstDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public HydraConstDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public HydraConstDocBrowserInformationControlInput getNext() {
		return fNext;
	}
