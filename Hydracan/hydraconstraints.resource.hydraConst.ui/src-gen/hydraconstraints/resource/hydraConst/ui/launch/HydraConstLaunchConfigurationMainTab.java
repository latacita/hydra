 ...
 * class.
 */
public class HydraConstLaunchConfigurationMainTab extends org.eclipse.debug.ui.AbstractLaunchConfigurationTab {
	...
	public void initializeFrom(org.eclipse.debug.core.ILaunchConfiguration configuration) {
		try {
			uriText.setText(configuration.getAttribute(hydraconstraints.resource.hydraConst.launch.HydraConstLaunchConfigurationDelegate.ATTR_RESOURCE_URI, ""));
			// more initialization code can be added here
		} catch (org.eclipse.core.runtime.CoreException e) {
			hydraconstraints.resource.hydraConst.mopp.HydraConstPlugin.logError("Can't initialize launch configuration tab.", e);
		}
	}
	
	public void performApply(org.eclipse.debug.core.ILaunchConfigurationWorkingCopy configuration) {
		configuration.setAttribute(hydraconstraints.resource.hydraConst.launch.HydraConstLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uriText.getText());
	}
	...
	public org.eclipse.swt.graphics.Image getImage() {
		return hydraconstraints.resource.hydraConst.ui.HydraConstImageProvider.INSTANCE.getImage("icons/launch_tab_main_icon.gif");
	}
	...
	protected void handleBrowseWorkspace() {
		...
		dialog.addFilter(new org.eclipse.jface.viewers.ViewerFilter() {
			...
			public boolean select(org.eclipse.jface.viewers.Viewer viewer, Object parentElement, Object element) {
				if (element instanceof org.eclipse.core.resources.IFile) {
					...
					return file.getFileExtension().equals(new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation().getSyntaxName());
				}
				return true;
			}
		});
		...
		dialog.setValidator(new org.eclipse.ui.dialogs.ISelectionStatusValidator() {
			public org.eclipse.core.runtime.IStatus validate(Object[] selection) {
				if (selection.length > 0 && selection[0] instanceof org.eclipse.core.resources.IFile)				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.OK, hydraconstraints.resource.hydraConst.ui.HydraConstUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.OK, "", null);
				
				return new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, hydraconstraints.resource.hydraConst.ui.HydraConstUIPlugin.PLUGIN_ID, org.eclipse.core.runtime.IStatus.ERROR, "", null);
			}
		});
