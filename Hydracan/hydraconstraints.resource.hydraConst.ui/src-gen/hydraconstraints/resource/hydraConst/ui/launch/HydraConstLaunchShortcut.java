 ...
 */
public class HydraConstLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(hydraconstraints.resource.hydraConst.launch.HydraConstLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			hydraconstraints.resource.hydraConst.mopp.HydraConstPlugin.logError("Exception while launching selection", e);
		}
	}
