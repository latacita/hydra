 ...
 * 
 */
package hydraconstraints.resource.hydraConst.ui.debug;

@SuppressWarnings("restriction")
public class HydraConstAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation().getSyntaxName())) {
					return new hydraconstraints.resource.hydraConst.ui.debug.HydraConstLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof hydraconstraints.resource.hydraConst.debug.HydraConstDebugVariable) {
			final hydraconstraints.resource.hydraConst.debug.HydraConstDebugVariable variable = (hydraconstraints.resource.hydraConst.debug.HydraConstDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof hydraconstraints.resource.hydraConst.debug.HydraConstDebugVariable) {
			final hydraconstraints.resource.hydraConst.debug.HydraConstDebugVariable variable = (hydraconstraints.resource.hydraConst.debug.HydraConstDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							hydraconstraints.resource.hydraConst.debug.HydraConstDebugValue castedValue = (hydraconstraints.resource.hydraConst.debug.HydraConstDebugValue) value;
