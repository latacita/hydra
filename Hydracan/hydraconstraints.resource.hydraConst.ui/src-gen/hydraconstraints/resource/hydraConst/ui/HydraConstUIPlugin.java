 ...
 */
public class HydraConstUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "hydraconstraints.resource.hydraConst.ui";
	public static final String EDITOR_ID = "hydraconstraints.resource.hydraConst.ui.HydraConstEditor";
	...
	private static HydraConstUIPlugin plugin;
	
	public HydraConstUIPlugin() {
		super();
	}
	...
	public static HydraConstUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, HydraConstUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, HydraConstUIPlugin.PLUGIN_ID, message);
		}
		final HydraConstUIPlugin pluginInstance = HydraConstUIPlugin.getDefault();
