 ...
 */
public class ConstraintCompletionProposal implements java.lang.Comparable<ConstraintCompletionProposal> {
	...
	public ConstraintCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public ConstraintCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public ConstraintCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof ConstraintCompletionProposal) {
			ConstraintCompletionProposal other = (ConstraintCompletionProposal) object;
	...
	public int compareTo(ConstraintCompletionProposal object) {
		if (object instanceof ConstraintCompletionProposal) {
			ConstraintCompletionProposal other = (ConstraintCompletionProposal) object;
