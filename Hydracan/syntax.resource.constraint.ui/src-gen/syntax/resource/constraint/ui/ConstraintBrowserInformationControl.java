 ...
 * @since 3.2
 */
public class ConstraintBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput fInput;
	 ...
	 */
	public ConstraintBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public ConstraintBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public ConstraintBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput);
		...
		fInput= (syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput) input;
		...
		syntax.resource.constraint.ui.ConstraintHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = syntax.resource.constraint.ui.ConstraintHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput getInput() {
		return fInput;
	}
