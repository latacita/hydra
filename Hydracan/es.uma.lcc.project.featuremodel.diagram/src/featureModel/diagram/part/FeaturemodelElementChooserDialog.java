 ...
 * @generated
 */
public class FeaturemodelElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public FeaturemodelElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						featureModel.diagram.part.Messages.FeaturemodelElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "featuremodel".equals(fileExtension); //$NON-NLS-1$
	}
