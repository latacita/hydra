...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPartDescriptor workbenchPartDescriptor) {
		...
		setText(featureModel.diagram.part.Messages.ValidateActionMessage);
	...
	public static void runValidation(View view) {
		try {
			if (featureModel.diagram.part.FeaturemodelDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		featureModel.diagram.providers.FeaturemodelValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			featureModel.diagram.providers.FeaturemodelMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		featureModel.diagram.part.FeaturemodelDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new featureModel.diagram.part.FeaturemodelDiagramEditorUtil.LazyElement2ViewMap(
		...
		for (Iterator<IStatus> it = allStatuses.iterator(); it.hasNext();) {
			...
			View view = featureModel.diagram.part.FeaturemodelDiagramEditorUtil
