...
public class FeaturemodelNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					featureModel.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof featureModel.diagram.navigator.FeaturemodelNavigatorItem) {
					selectedElement = ((featureModel.diagram.navigator.FeaturemodelNavigatorItem) selectedElement)
							.getView();
