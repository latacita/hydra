...
public class FeaturemodelBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest
						.setParameter(
								featureModel.diagram.edit.helpers.FeaturemodelBaseEditHelper.EDIT_POLICY_COMMAND,
								command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		private static featureModel.diagram.expressions.FeaturemodelAbstractExpression RelationFeature_4013_SourceExpression;

		/**
		 * @generated
		 */
		public static boolean canCreateRelationFG_4012(
				featureModel.Project container, featureModel.Node source,
				featureModel.Node target) {
			return canExistRelationFG_4012(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateRelationFeature_4013(
				featureModel.Project container, featureModel.Feature source,
				featureModel.Feature target) {
			return canExistRelationFeature_4013(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistRelationFG_4012(
				featureModel.Project container, featureModel.Node source,
				featureModel.Node target) {
		 ...
		 * @generated
		 */
		public static boolean canExistRelationFeature_4013(
				featureModel.Project container, featureModel.Feature source,
				featureModel.Feature target) {
			try {
				if (source == null) {
				...
				if (RelationFeature_4013_SourceExpression == null) {
					Map<String, EClass> env = Collections.singletonMap(OPPOSITE_END_VAR,
							featureModel.FeatureModelPackage.eINSTANCE
									.getFeature());
					RelationFeature_4013_SourceExpression = featureModel.diagram.expressions.FeaturemodelOCLFactory
							.getExpression(
									"self <> oppositeEnd", featureModel.FeatureModelPackage.eINSTANCE.getFeature(), env); //$NON-NLS-1$
				}
				Object sourceVal = RelationFeature_4013_SourceExpression
