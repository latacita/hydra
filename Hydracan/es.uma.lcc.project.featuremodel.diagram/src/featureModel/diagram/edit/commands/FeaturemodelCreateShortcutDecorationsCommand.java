 ...
 * @generated
 */
public class FeaturemodelCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public FeaturemodelCreateShortcutDecorationsCommand(
		...
		for (Iterator<?> it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation
						.getDetails()
						.put(
								"modelID", featureModel.diagram.edit.parts.ProjectEditPart.MODEL_ID); //$NON-NLS-1$
