...
import featureModel.diagram.edit.policies.FeatureGroupATC;
import featureModel.diagram.part.FeaturemodelDiagramEditorPlugin;
...
public class FeatureGroupEditPart extends AbstractBorderedShapeEditPart {
	...
	public FeatureGroupEditPart(View view) {
		super(view);
		URL url = FileLocator.find(FeaturemodelDiagramEditorPlugin
				.getInstance().getBundle(), new Path(
				"icons/wizban/empty_FG.svg"), null); //$NON-NLS-1$
		emptyFigure = RenderedImageFactory.getInstance(url);
		url = FileLocator.find(FeaturemodelDiagramEditorPlugin.getInstance()
				.getBundle(), new Path("icons/wizban/full_FG.svg"), null); //$NON-NLS-1$
	...
	public void updateFace() {
		...
		//		Connection myConnection = createConnectionFigure();
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new featureModel.diagram.edit.policies.FeatureGroupItemSemanticEditPolicy());
	...
	private OpenEditPolicy createOpenEditPolicy() {
		OpenEditPolicy policy = new OpenEditPolicy() {
			protected Command getOpenCommand(Request request) {
				return new ICommandProxy(new FeatureGroupATC(
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof featureModel.diagram.edit.parts.FeatureGroupLowerBoundUpperBoundEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(featureModel.diagram.part.FeaturemodelVisualIDRegistry
