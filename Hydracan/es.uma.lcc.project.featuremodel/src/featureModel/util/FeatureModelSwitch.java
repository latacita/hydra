...
public class FeatureModelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FeatureModelPackage.RELATION_FG: {
				RelationFG relationFG = (RelationFG)theEObject;
				T result = caseRelationFG(relationFG);
				if (result == null) result = caseRelation(relationFG);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FeatureModelPackage.RELATION_FEATURE: {
				RelationFeature relationFeature = (RelationFeature)theEObject;
				T result = caseRelationFeature(relationFeature);
				if (result == null) result = caseRelation(relationFeature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Relation FG</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Relation FG</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRelationFG(RelationFG object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Relation Feature</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Relation Feature</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRelationFeature(RelationFeature object) {
		return null;
	}
