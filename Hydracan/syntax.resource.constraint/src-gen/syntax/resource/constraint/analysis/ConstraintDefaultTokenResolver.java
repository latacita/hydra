 ...
 */
public class ConstraintDefaultTokenResolver implements syntax.resource.constraint.IConstraintTokenResolver {
	 ...
	 */
	public ConstraintDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public ConstraintDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, syntax.resource.constraint.IConstraintTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : syntax.resource.constraint.grammar.ConstraintGrammarInformationProvider.INSTANCE.getKeywords()) {
