...
public class ConstraintNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "syntax.resource.constraint.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {syntax.resource.constraint.mopp.ConstraintBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(syntax.resource.constraint.mopp.ConstraintBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
