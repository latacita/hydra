 ...
 * <ul>
 *   <li>{@link syntax.UnaryOp#getUnaryOp <em>Unary Op</em>}</li>
 * </ul>
 * </p>
 *
 * @see syntax.SyntaxPackage#getUnaryOp()
 * @model abstract="true"
 * @generated
 */
public interface UnaryOp extends LogicalOperator {
	 ...
	 * @see syntax.SyntaxPackage#getUnaryOp_UnaryOp()
	...
	/**
	 * Sets the value of the '{@link syntax.UnaryOp#getUnaryOp <em>Unary Op</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
