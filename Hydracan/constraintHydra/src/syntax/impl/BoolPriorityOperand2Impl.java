 ...
 * <ul>
 *   <li>{@link syntax.impl.BoolPriorityOperand2Impl#getBoolPriorityOp2 <em>Bool Priority Op2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoolPriorityOperand2Impl extends EObjectImpl implements BoolPriorityOperand2 {
	...
	protected EClass eStaticClass() {
		return SyntaxPackage.Literals.BOOL_PRIORITY_OPERAND2;
	}
	...
	public NotificationChain basicSetBoolPriorityOp2(BoolOperand newBoolPriorityOp2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.BOOL_PRIORITY_OPERAND2__BOOL_PRIORITY_OP2, oldBoolPriorityOp2, newBoolPriorityOp2);
	...
	public void setBoolPriorityOp2(BoolOperand newBoolPriorityOp2) {
		if (newBoolPriorityOp2 != boolPriorityOp2) {
			...
			if (boolPriorityOp2 != null)
				msgs = ((InternalEObject)boolPriorityOp2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.BOOL_PRIORITY_OPERAND2__BOOL_PRIORITY_OP2, null, msgs);
			if (newBoolPriorityOp2 != null)
				msgs = ((InternalEObject)newBoolPriorityOp2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.BOOL_PRIORITY_OPERAND2__BOOL_PRIORITY_OP2, null, msgs);
			msgs = basicSetBoolPriorityOp2(newBoolPriorityOp2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.BOOL_PRIORITY_OPERAND2__BOOL_PRIORITY_OP2, newBoolPriorityOp2, newBoolPriorityOp2));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SyntaxPackage.BOOL_PRIORITY_OPERAND2__BOOL_PRIORITY_OP2:
