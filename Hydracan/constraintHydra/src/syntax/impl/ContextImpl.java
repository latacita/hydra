 ...
 * <ul>
 *   <li>{@link syntax.impl.ContextImpl#getContextOp1 <em>Context Op1</em>}</li>
 *   <li>{@link syntax.impl.ContextImpl#getContextOp2 <em>Context Op2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContextImpl extends BoolOperandChoicesImpl implements Context {
	...
	protected EClass eStaticClass() {
		return SyntaxPackage.Literals.CONTEXT;
	}
	...
	public NotificationChain basicSetContextOp1(MultipleFeature newContextOp1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.CONTEXT__CONTEXT_OP1, oldContextOp1, newContextOp1);
	...
	public void setContextOp1(MultipleFeature newContextOp1) {
		if (newContextOp1 != contextOp1) {
			...
			if (contextOp1 != null)
				msgs = ((InternalEObject)contextOp1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.CONTEXT__CONTEXT_OP1, null, msgs);
			if (newContextOp1 != null)
				msgs = ((InternalEObject)newContextOp1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.CONTEXT__CONTEXT_OP1, null, msgs);
			msgs = basicSetContextOp1(newContextOp1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.CONTEXT__CONTEXT_OP1, newContextOp1, newContextOp1));
	}
	...
	public NotificationChain basicSetContextOp2(Constraint newContextOp2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.CONTEXT__CONTEXT_OP2, oldContextOp2, newContextOp2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContextOp2(Constraint newContextOp2) {
		if (newContextOp2 != contextOp2) {
			NotificationChain msgs = null;
			if (contextOp2 != null)
				msgs = ((InternalEObject)contextOp2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.CONTEXT__CONTEXT_OP2, null, msgs);
			if (newContextOp2 != null)
				msgs = ((InternalEObject)newContextOp2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.CONTEXT__CONTEXT_OP2, null, msgs);
			msgs = basicSetContextOp2(newContextOp2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.CONTEXT__CONTEXT_OP2, newContextOp2, newContextOp2));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SyntaxPackage.CONTEXT__CONTEXT_OP1:
				return basicSetContextOp1(null, msgs);
			case SyntaxPackage.CONTEXT__CONTEXT_OP2:
