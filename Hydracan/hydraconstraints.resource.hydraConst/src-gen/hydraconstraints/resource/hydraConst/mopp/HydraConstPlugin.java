 ...
 */
public class HydraConstPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "hydraconstraints.resource.hydraConst";
	/**
	...
	private static HydraConstPlugin plugin;
	
	public HydraConstPlugin() {
		super();
	}
	...
	public static HydraConstPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, HydraConstPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, HydraConstPlugin.PLUGIN_ID, message);
		}
		final HydraConstPlugin pluginInstance = HydraConstPlugin.getDefault();
