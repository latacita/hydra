...
public class HydraConstNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "hydraconstraints.resource.hydraConst.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {hydraconstraints.resource.hydraConst.mopp.HydraConstBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(hydraconstraints.resource.hydraConst.mopp.HydraConstBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
