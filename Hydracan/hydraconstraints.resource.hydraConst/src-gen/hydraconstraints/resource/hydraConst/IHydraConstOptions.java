 ...
 */
public interface IHydraConstOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation().getResourcePostProcessorProviderOptionKey();
