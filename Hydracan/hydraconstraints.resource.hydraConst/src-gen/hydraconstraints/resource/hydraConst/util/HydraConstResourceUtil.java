 ...
 */
public class HydraConstResourceUtil {
	...
	public static hydraconstraints.resource.hydraConst.mopp.HydraConstResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (hydraconstraints.resource.hydraConst.mopp.HydraConstResource) csResource;
	}
	
	public static hydraconstraints.resource.hydraConst.mopp.HydraConstResource getResource(java.io.File file) {
	...
	public static hydraconstraints.resource.hydraConst.mopp.HydraConstResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (hydraconstraints.resource.hydraConst.mopp.HydraConstResource) resource;
	}
	
	/**
	 * Returns the root element of the resource with the given URI.
	 */
	public static hydraconstraints.Model getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static hydraconstraints.Model getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (hydraconstraints.Model) root;
	}
