 ...
 * to 4 bytes).
 */
public class HydraConstUnicodeConverter extends hydraconstraints.resource.hydraConst.mopp.HydraConstInputStreamProcessor {
	 ...
	 */
	public HydraConstUnicodeConverter(java.io.InputStream inputStream) {
