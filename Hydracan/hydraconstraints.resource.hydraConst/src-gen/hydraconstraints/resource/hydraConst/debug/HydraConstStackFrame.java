...
public class HydraConstStackFrame extends hydraconstraints.resource.hydraConst.debug.HydraConstDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private hydraconstraints.resource.hydraConst.debug.HydraConstDebugTarget target;
	private String name;
	private int id;
	...
	public HydraConstStackFrame(hydraconstraints.resource.hydraConst.debug.HydraConstDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = hydraconstraints.resource.hydraConst.util.HydraConstStringUtil.decode(data, ',');
	...
	private hydraconstraints.resource.hydraConst.debug.HydraConstDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		hydraconstraints.resource.hydraConst.debug.HydraConstStackFrame other = (hydraconstraints.resource.hydraConst.debug.HydraConstStackFrame) obj;
		if (name == null) {
