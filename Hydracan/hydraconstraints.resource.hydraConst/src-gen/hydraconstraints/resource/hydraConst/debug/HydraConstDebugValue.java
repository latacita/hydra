...
public class HydraConstDebugValue extends hydraconstraints.resource.hydraConst.debug.HydraConstDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public HydraConstDebugValue(hydraconstraints.resource.hydraConst.debug.HydraConstDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
