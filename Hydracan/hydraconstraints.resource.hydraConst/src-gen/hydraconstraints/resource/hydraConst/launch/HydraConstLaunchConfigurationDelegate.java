 ...
 */
public class HydraConstLaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new hydraconstraints.resource.hydraConst.launch.HydraConstLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
