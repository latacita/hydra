 ...
 * @generated
 */
public class FeatureItemSemanticEditPolicy
		extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (specializationModel.diagram.providers.SpecializationmodelElementTypes.RelationFeature_4002 == req
				.getElementType()) {
			return getGEFWrapper(new specializationModel.diagram.edit.commands.RelationFeatureCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
//		if (specializationModel.diagram.providers.SpecializationmodelElementTypes.RelationSelected_4003 == req
//				.getElementType()) {
//			return getGEFWrapper(new specializationModel.diagram.edit.commands.RelationSelectedCreateCommand(
//					req, req.getSource(), req.getTarget()));
//		}
		return null;
	}
...
//		}
	...
	protected Command getReorientRelationshipCommand(
		...
		case specializationModel.diagram.edit.parts.RelationFeatureEditPart.VISUAL_ID:
			return getGEFWrapper(new specializationModel.diagram.edit.commands.RelationFeatureReorientCommand(
					req));
//		case specializationModel.diagram.edit.parts.RelationSelectedEditPart.VISUAL_ID:
//			return getGEFWrapper(new specializationModel.diagram.edit.commands.RelationSelectedReorientCommand(
//					req));
		}
