 ...
 * <ul>
 *   <li>{@link HydraConstraints.impl.NumPriorityOperand2Impl#getNumPriorityOp2 <em>Num Priority Op2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NumPriorityOperand2Impl extends EObjectImpl implements NumPriorityOperand2 {
	...
	protected EClass eStaticClass() {
		return HydraConstraintsPackage.Literals.NUM_PRIORITY_OPERAND2;
	}
	...
	public NotificationChain basicSetNumPriorityOp2(NumOperand newNumPriorityOp2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HydraConstraintsPackage.NUM_PRIORITY_OPERAND2__NUM_PRIORITY_OP2, oldNumPriorityOp2, newNumPriorityOp2);
	...
	public void setNumPriorityOp2(NumOperand newNumPriorityOp2) {
		if (newNumPriorityOp2 != numPriorityOp2) {
			...
			if (numPriorityOp2 != null)
				msgs = ((InternalEObject)numPriorityOp2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HydraConstraintsPackage.NUM_PRIORITY_OPERAND2__NUM_PRIORITY_OP2, null, msgs);
			if (newNumPriorityOp2 != null)
				msgs = ((InternalEObject)newNumPriorityOp2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HydraConstraintsPackage.NUM_PRIORITY_OPERAND2__NUM_PRIORITY_OP2, null, msgs);
			msgs = basicSetNumPriorityOp2(newNumPriorityOp2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HydraConstraintsPackage.NUM_PRIORITY_OPERAND2__NUM_PRIORITY_OP2, newNumPriorityOp2, newNumPriorityOp2));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HydraConstraintsPackage.NUM_PRIORITY_OPERAND2__NUM_PRIORITY_OP2:
