...
/**
 * A IConstraintReferenceResolverSwitch holds references to multiple other
 * reference resolvers and delegates requests to the appropriate resolver.
 */
public interface IConstraintReferenceResolverSwitch extends syntax.resource.constraint.IConstraintConfigurable {
