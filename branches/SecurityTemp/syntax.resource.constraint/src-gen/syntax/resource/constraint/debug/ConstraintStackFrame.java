...
public class ConstraintStackFrame extends syntax.resource.constraint.debug.ConstraintDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private syntax.resource.constraint.debug.ConstraintDebugTarget target;
	private String name;
	private int id;
	...
	public ConstraintStackFrame(syntax.resource.constraint.debug.ConstraintDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = syntax.resource.constraint.util.ConstraintStringUtil.decode(data, ',');
	...
	private syntax.resource.constraint.debug.ConstraintDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		syntax.resource.constraint.debug.ConstraintStackFrame other = (syntax.resource.constraint.debug.ConstraintStackFrame) obj;
		if (name == null) {
