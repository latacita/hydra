...
Las instrucciones que fueron puestas a prueba, y que se comprobó que en efecto eran parseadas de un modo apropiado, fueron las que se ven en la figura \ref{figmetains}. Este conjunto de instrucciones servirán como pruebas también en momentos más avanzados del desarrollo.