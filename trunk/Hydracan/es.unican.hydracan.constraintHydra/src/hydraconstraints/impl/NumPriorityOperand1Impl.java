 ...
 * <ul>
 *   <li>{@link hydraconstraints.impl.NumPriorityOperand1Impl#getNumPriorityOp1 <em>Num Priority Op1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NumPriorityOperand1Impl extends EObjectImpl implements NumPriorityOperand1 {
	...
	protected EClass eStaticClass() {
		return HydraconstraintsPackage.Literals.NUM_PRIORITY_OPERAND1;
	}
	...
	public NotificationChain basicSetNumPriorityOp1(NumOperand newNumPriorityOp1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HydraconstraintsPackage.NUM_PRIORITY_OPERAND1__NUM_PRIORITY_OP1, oldNumPriorityOp1, newNumPriorityOp1);
	...
	public void setNumPriorityOp1(NumOperand newNumPriorityOp1) {
		if (newNumPriorityOp1 != numPriorityOp1) {
			...
			if (numPriorityOp1 != null)
				msgs = ((InternalEObject)numPriorityOp1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HydraconstraintsPackage.NUM_PRIORITY_OPERAND1__NUM_PRIORITY_OP1, null, msgs);
			if (newNumPriorityOp1 != null)
				msgs = ((InternalEObject)newNumPriorityOp1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HydraconstraintsPackage.NUM_PRIORITY_OPERAND1__NUM_PRIORITY_OP1, null, msgs);
			msgs = basicSetNumPriorityOp1(newNumPriorityOp1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HydraconstraintsPackage.NUM_PRIORITY_OPERAND1__NUM_PRIORITY_OP1, newNumPriorityOp1, newNumPriorityOp1));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HydraconstraintsPackage.NUM_PRIORITY_OPERAND1__NUM_PRIORITY_OP1:
