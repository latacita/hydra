 ...
 */
public class HydraConstSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public HydraConstSyntaxColoringPreferencePage() {
		super();
		
		hydraconstraints.resource.hydraConst.IHydraConstMetaInformation syntaxPlugin = new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, hydraconstraints.resource.hydraConst.ui.HydraConstSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		hydraconstraints.resource.hydraConst.ui.HydraConstPixelConverter pixelConverter = new hydraconstraints.resource.hydraConst.ui.HydraConstPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof hydraconstraints.resource.hydraConst.ui.HydraConstEditor) {
			hydraconstraints.resource.hydraConst.ui.HydraConstEditor emfTextEditor = (hydraconstraints.resource.hydraConst.ui.HydraConstEditor) editor;
