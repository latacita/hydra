 ...
 */
public class HydraConstCodeFoldingManager {
	
	private class FoldingUpdateListener implements hydraconstraints.resource.hydraConst.IHydraConstBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(hydraconstraints.resource.hydraConst.ui.HydraConstEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof hydraconstraints.resource.hydraConst.ui.HydraConstEditor) {
				hydraconstraints.resource.hydraConst.ui.HydraConstEditor editor = (hydraconstraints.resource.hydraConst.ui.HydraConstEditor) workbenchPart;
	...
	protected hydraconstraints.resource.hydraConst.ui.HydraConstEditor editor;
	 ...
	 */
	public HydraConstCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,hydraconstraints.resource.hydraConst.ui.HydraConstEditor textEditor) {
	...
	private void addCloseListener(final hydraconstraints.resource.hydraConst.ui.HydraConstEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			hydraconstraints.resource.hydraConst.ui.HydraConstUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		hydraconstraints.resource.hydraConst.IHydraConstTextResource textResource = (hydraconstraints.resource.hydraConst.IHydraConstTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
