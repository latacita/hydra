 ...
 */
public class HydraConstNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public HydraConstNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("hydraconstraints.resource.hydraConst.ui");
							...
							String natureID = hydraconstraints.resource.hydraConst.mopp.HydraConstNature.NATURE_ID;
							...
							for (String builderID : hydraconstraints.resource.hydraConst.mopp.HydraConstNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation info = new hydraconstraints.resource.hydraConst.mopp.HydraConstMetaInformation();
