 ...
 */
public class HydraConstTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private hydraconstraints.resource.hydraConst.IHydraConstHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final hydraconstraints.resource.hydraConst.ui.HydraConstBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(hydraconstraints.resource.hydraConst.ui.HydraConstBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput infoInput = (hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					hydraconstraints.resource.hydraConst.ui.HydraConstHyperlink hyperlink = new hydraconstraints.resource.hydraConst.ui.HydraConstHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (hydraconstraints.resource.hydraConst.ui.HydraConstBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				hydraconstraints.resource.hydraConst.ui.HydraConstBrowserInformationControl iControl = new hydraconstraints.resource.hydraConst.ui.HydraConstBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput) {
							hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput input = (hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (hydraconstraints.resource.hydraConst.ui.HydraConstBrowserInformationControl.isAvailable(parent)) {
				hydraconstraints.resource.hydraConst.ui.HydraConstBrowserInformationControl iControl = new hydraconstraints.resource.hydraConst.ui.HydraConstBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public HydraConstTextHover(hydraconstraints.resource.hydraConst.IHydraConstResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new hydraconstraints.resource.hydraConst.ui.HydraConstUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				hydraconstraints.resource.hydraConst.ui.HydraConstHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			hydraconstraints.resource.hydraConst.ui.HydraConstHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			hydraconstraints.resource.hydraConst.ui.HydraConstHTMLPrinter.insertPageProlog(buffer, 0, hydraconstraints.resource.hydraConst.ui.HydraConstTextHover.getStyleSheet());
			hydraconstraints.resource.hydraConst.ui.HydraConstHTMLPrinter.addPageEpilog(buffer);
			return new hydraconstraints.resource.hydraConst.ui.HydraConstDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = hydraconstraints.resource.hydraConst.ui.HydraConstHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(hydraconstraints.resource.hydraConst.ui.HydraConstUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return hydraconstraints.resource.hydraConst.util.HydraConstStreamUtil.getContent(styleSheetURL.openStream());
