 ...
 */
public class HydraConstHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public HydraConstHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				hydraconstraints.resource.hydraConst.mopp.HydraConstPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
