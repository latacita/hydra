...
public class HydraConstLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(hydraconstraints.resource.hydraConst.mopp.HydraConstPlugin.DEBUG_MODEL_ID);
			...
			hydraconstraints.resource.hydraConst.debug.HydraConstLineBreakpoint lineBreakpoint = new hydraconstraints.resource.hydraConst.debug.HydraConstLineBreakpoint(resource, lineNumber + 1);
