 ...
 * a specified depth.
 */
public class HydraConstOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public HydraConstOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof hydraconstraints.resource.hydraConst.ui.HydraConstEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			hydraconstraints.resource.hydraConst.mopp.HydraConstPlugin.logError("Exception while refreshing outline view", e);
		}
	}
