 ...
 * resolver
 */
public interface IHydraConstReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends hydraconstraints.resource.hydraConst.IHydraConstConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, hydraconstraints.resource.hydraConst.IHydraConstReferenceResolveResult<ReferenceType> result);
