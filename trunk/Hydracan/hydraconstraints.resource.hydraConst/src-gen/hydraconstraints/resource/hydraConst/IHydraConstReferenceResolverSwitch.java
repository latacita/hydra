...
/**
 * A IHydraConstReferenceResolverSwitch holds references to multiple other
 * reference resolvers and delegates requests to the appropriate resolver.
 */
public interface IHydraConstReferenceResolverSwitch extends hydraconstraints.resource.hydraConst.IHydraConstConfigurable {
