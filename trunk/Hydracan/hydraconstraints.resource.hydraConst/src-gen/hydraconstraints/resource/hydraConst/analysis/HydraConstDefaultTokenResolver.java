 ...
 */
public class HydraConstDefaultTokenResolver implements hydraconstraints.resource.hydraConst.IHydraConstTokenResolver {
	 ...
	 */
	public HydraConstDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public HydraConstDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, hydraconstraints.resource.hydraConst.IHydraConstTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : hydraconstraints.resource.hydraConst.grammar.HydraConstGrammarInformationProvider.INSTANCE.getKeywords()) {
