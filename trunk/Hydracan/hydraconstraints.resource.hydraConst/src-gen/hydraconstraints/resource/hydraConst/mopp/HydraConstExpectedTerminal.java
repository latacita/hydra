 ...
 */
public class HydraConstExpectedTerminal {
	
	private int followSetID;
	private hydraconstraints.resource.hydraConst.IHydraConstExpectedElement terminal;
	...
	public HydraConstExpectedTerminal(hydraconstraints.resource.hydraConst.IHydraConstExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public hydraconstraints.resource.hydraConst.IHydraConstExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((HydraConstExpectedTerminal) o).terminal);
	}
