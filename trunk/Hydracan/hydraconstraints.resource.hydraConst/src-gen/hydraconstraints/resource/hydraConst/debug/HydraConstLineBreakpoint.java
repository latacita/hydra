...
public class HydraConstLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "hydraconstraints.resource.hydraConst.debug.lineBreakpoint.marker";
	
	public HydraConstLineBreakpoint() {
		super();
	}
	
	public HydraConstLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(hydraconstraints.resource.hydraConst.debug.HydraConstDebugTarget target) {
		try {
	...
	public void remove(hydraconstraints.resource.hydraConst.debug.HydraConstDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
