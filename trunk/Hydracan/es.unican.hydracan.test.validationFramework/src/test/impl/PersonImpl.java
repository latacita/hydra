 ...
 * <ul>
 *   <li>{@link test.impl.PersonImpl#getAge <em>Age</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
				...
				diag.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 ...
						 TestValidator.PERSON__IS_AGE_VALID,
						 // EcorePlugin.INSTANCE.getString("_UI_GenericInvariant_diagnostic", 
						 //		 new Object[] {"isAgeValid", EObjectValidator.getObjectLabel(this, context) }),
						 "Age cannot be under 0",
						 new Object [] { this }));
			}
			return false;
		}
