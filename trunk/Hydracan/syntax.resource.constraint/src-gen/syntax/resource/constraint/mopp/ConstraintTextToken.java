...
public class ConstraintTextToken implements syntax.resource.constraint.IConstraintTextToken {
	
	private final syntax.resource.constraint.IConstraintMetaInformation metaInformation = new syntax.resource.constraint.mopp.ConstraintMetaInformation();
	private final org.antlr.runtime3_3_0.Token antlrToken;
	
	public ConstraintTextToken(org.antlr.runtime3_3_0.Token antlrToken) {
		super();
