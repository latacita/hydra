 ...
 */
public class ConstraintMinimalModelHelper {
	
	private final static syntax.resource.constraint.util.ConstraintEClassUtil eClassUtil = new syntax.resource.constraint.util.ConstraintEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + syntax.resource.constraint.util.ConstraintStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = syntax.resource.constraint.util.ConstraintListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if (attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + syntax.resource.constraint.util.ConstraintStringUtil.capitalize(attribute.getName());
					}
					Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = syntax.resource.constraint.util.ConstraintListUtil.castListUnchecked(value);
