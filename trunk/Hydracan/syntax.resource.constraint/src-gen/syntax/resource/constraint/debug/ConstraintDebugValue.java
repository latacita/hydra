...
public class ConstraintDebugValue extends syntax.resource.constraint.debug.ConstraintDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public ConstraintDebugValue(syntax.resource.constraint.debug.ConstraintDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
