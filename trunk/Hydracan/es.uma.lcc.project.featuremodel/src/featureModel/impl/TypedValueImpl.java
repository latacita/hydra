 ...
 * <ul>
 *   <li>{@link featureModel.impl.TypedValueImpl#getIntegerValue <em>Integer Value</em>}</li>
 *   <li>{@link featureModel.impl.TypedValueImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link featureModel.impl.TypedValueImpl#getFloatValue <em>Float Value</em>}</li>
 *   <li>{@link featureModel.impl.TypedValueImpl#getFeatureValue <em>Feature Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypedValueImpl extends EObjectImpl implements TypedValue {
	...
	protected EClass eStaticClass() {
		return FeatureModelPackage.Literals.TYPED_VALUE;
	}
	...
	public void setIntegerValue(Integer newIntegerValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.TYPED_VALUE__INTEGER_VALUE, oldIntegerValue, integerValue));
	}
	...
	public void setStringValue(String newStringValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.TYPED_VALUE__STRING_VALUE, oldStringValue, stringValue));
	}
	...
	public void setFloatValue(Float newFloatValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.TYPED_VALUE__FLOAT_VALUE, oldFloatValue, floatValue));
	}
	...
	public Feature getFeatureValue() {
		if (featureValue != null && featureValue.eIsProxy()) {
			...
			if (featureValue != oldFeatureValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, FeatureModelPackage.TYPED_VALUE__FEATURE_VALUE, oldFeatureValue, featureValue));
			}
		}
		return featureValue;
	}
	...
	public void setFeatureValue(Feature newFeatureValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatureModelPackage.TYPED_VALUE__FEATURE_VALUE, oldFeatureValue, featureValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FeatureModelPackage.TYPED_VALUE__FEATURE_VALUE:
