 ...
 * @generated
 */
public class SpecializationModelPackageImpl extends EPackageImpl implements SpecializationModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see specializationModel.SpecializationModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private SpecializationModelPackageImpl() {
		super(eNS_URI, SpecializationModelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link SpecializationModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static SpecializationModelPackage init() {
		if (isInited) return (SpecializationModelPackage)EPackage.Registry.INSTANCE.getEPackage(SpecializationModelPackage.eNS_URI);

		// Obtain or create and register package
		SpecializationModelPackageImpl theSpecializationModelPackage = (SpecializationModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof SpecializationModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new SpecializationModelPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theSpecializationModelPackage.createPackageContents();

		// Initialize created meta-data
		theSpecializationModelPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theSpecializationModelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(SpecializationModelPackage.eNS_URI, theSpecializationModelPackage);
		return theSpecializationModelPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getFeature_RealName() {
	 ...
	 * @generated
	 */
	public EAttribute getProject_FeatureModelURI() {
	 ...
	 * @generated
	 */
	public EAttribute getProject_InfiniteDomain() {
	 ...
	 * @generated
	 */
	public EAttribute getProject_UserConstraintsState() {
	 ...
	 * @generated
	 */
	public SpecializationModelFactory getSpecializationModelFactory() {
		return (SpecializationModelFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(featureEClass, FEATURE__REAL_NAME);
		...
		createEAttribute(projectEClass, PROJECT__FEATURE_MODEL_URI);
		...
		createEAttribute(projectEClass, PROJECT__INFINITE_DOMAIN);
		createEAttribute(projectEClass, PROJECT__USER_CONSTRAINTS_STATE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getFeature_State(), this.getConfigState(), "state", "", 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFeature_RealName(), ecorePackage.getEString(), "realName", "", 1, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProject_FeatureModelURI(), ecorePackage.getEString(), "featureModelURI", null, 0, 1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getProject_NumberOfProducts(), ecorePackage.getEInt(), "numberOfProducts", null, 0, 1, Project.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProject_InfiniteDomain(), ecorePackage.getEBoolean(), "infiniteDomain", "false", 0, 1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProject_UserConstraintsState(), ecorePackage.getEBoolean(), "userConstraintsState", null, 0, 1, Project.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(configStateEEnum, ConfigState.UNDECIDED);
...
} //SpecializationModelPackageImpl
