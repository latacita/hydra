 ...
 */
public class ConstraintEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private syntax.resource.constraint.ui.ConstraintQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public ConstraintEditorConfiguration(syntax.resource.constraint.IConstraintResourceProvider resourceProvider, syntax.resource.constraint.ui.IConstraintAnnotationModelProvider annotationModelProvider, syntax.resource.constraint.ui.IConstraintBracketHandlerProvider bracketHandlerProvider, syntax.resource.constraint.ui.ConstraintColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new syntax.resource.constraint.ui.ConstraintCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new syntax.resource.constraint.ui.ConstraintTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new syntax.resource.constraint.ui.ConstraintTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new syntax.resource.constraint.ui.ConstraintHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new syntax.resource.constraint.ui.ConstraintQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
