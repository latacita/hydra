 ...
 */
public class ConstraintSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public ConstraintSyntaxColoringPreferencePage() {
		super();
		
		syntax.resource.constraint.IConstraintMetaInformation syntaxPlugin = new syntax.resource.constraint.mopp.ConstraintMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, syntax.resource.constraint.ui.ConstraintSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		syntax.resource.constraint.ui.ConstraintPixelConverter pixelConverter = new syntax.resource.constraint.ui.ConstraintPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof syntax.resource.constraint.ui.ConstraintEditor) {
			syntax.resource.constraint.ui.ConstraintEditor emfTextEditor = (syntax.resource.constraint.ui.ConstraintEditor) editor;
