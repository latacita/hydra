 ...
 */
public class ConstraintCodeFoldingManager {
	
	private class FoldingUpdateListener implements syntax.resource.constraint.IConstraintBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(syntax.resource.constraint.ui.ConstraintEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof syntax.resource.constraint.ui.ConstraintEditor) {
				syntax.resource.constraint.ui.ConstraintEditor editor = (syntax.resource.constraint.ui.ConstraintEditor) workbenchPart;
	...
	protected syntax.resource.constraint.ui.ConstraintEditor editor;
	 ...
	 */
	public ConstraintCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,syntax.resource.constraint.ui.ConstraintEditor textEditor) {
	...
	private void addCloseListener(final syntax.resource.constraint.ui.ConstraintEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			syntax.resource.constraint.ui.ConstraintUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		syntax.resource.constraint.IConstraintTextResource textResource = (syntax.resource.constraint.IConstraintTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
