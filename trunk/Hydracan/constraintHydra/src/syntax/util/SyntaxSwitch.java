...
public class SyntaxSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SyntaxPackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SyntaxPackage.OPERAND: {
				Operand operand = (Operand)theEObject;
				T result = caseOperand(operand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SyntaxPackage.BOOL_OPERAND: {
			...
			case SyntaxPackage.NUM_OPERAND: {
			...
			case SyntaxPackage.SIMPLE_FEATURE: {
			...
			case SyntaxPackage.MULTIPLE_FEATURE: {
			...
			case SyntaxPackage.NUMBER: {
				syntax.Number number = (syntax.Number)theEObject;
			...
			case SyntaxPackage.LOGICAL_OPERATOR: {
			...
			case SyntaxPackage.NUM_OPERATOR: {
			...
			case SyntaxPackage.LESS_OR_EQUAL: {
			...
			case SyntaxPackage.MORE_OR_EQUAL: {
			...
			case SyntaxPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SyntaxPackage.NUM_OPERAND_CHOICES: {
			...
			case SyntaxPackage.BOOL_OPERAND_CHOICES: {
			...
			case SyntaxPackage.BOOL_PRIORITY_OPERAND1: {
			...
			case SyntaxPackage.NUM_PRIORITY_OPERAND2: {
			...
			case SyntaxPackage.BOOL_PRIORITY_OPERAND2: {
			...
			case SyntaxPackage.NUM_PRIORITY_OPERAND1: {
	 ...
	 * @generated
	 */
	public T caseNumber(syntax.Number object) {
		return null;
	}
