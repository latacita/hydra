	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case featureModel.diagram.edit.parts.ProjectEditPart.VISUAL_ID:
				return new featureModel.diagram.edit.parts.ProjectEditPart(view);

			case featureModel.diagram.edit.parts.FeatureEditPart.VISUAL_ID:
				return new featureModel.diagram.edit.parts.FeatureEditPart(view);

			case featureModel.diagram.edit.parts.FeatureNameEditPart.VISUAL_ID:
				return new featureModel.diagram.edit.parts.FeatureNameEditPart(
						view);

			case featureModel.diagram.edit.parts.FeatureGroupEditPart.VISUAL_ID:
				return new featureModel.diagram.edit.parts.FeatureGroupEditPart(
						view);

			case featureModel.diagram.edit.parts.FeatureGroupLowerBoundUpperBoundEditPart.VISUAL_ID:
				return new featureModel.diagram.edit.parts.FeatureGroupLowerBoundUpperBoundEditPart(
						view);

			case featureModel.diagram.edit.parts.RelationFGEditPart.VISUAL_ID:
				return new featureModel.diagram.edit.parts.RelationFGEditPart(
						view);

			case featureModel.diagram.edit.parts.RelationFeatureEditPart.VISUAL_ID:
				return new featureModel.diagram.edit.parts.RelationFeatureEditPart(
						view);

			case featureModel.diagram.edit.parts.RelationFeatureLowerBoundUpperBoundEditPart.VISUAL_ID:
				return new featureModel.diagram.edit.parts.RelationFeatureLowerBoundUpperBoundEditPart(
						view);
			}
		}
