 ...
 * @generated
 */
public class SpecializationmodelBaseItemSemanticEditPolicy extends
		SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest
						.setParameter(
								specializationModel.diagram.edit.helpers.SpecializationmodelBaseEditHelper.EDIT_POLICY_COMMAND,
								command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		private static specializationModel.diagram.expressions.SpecializationmodelAbstractExpression RelationFeature_4002_SourceExpression;
		/**
		 * @generated
		 */
		private static specializationModel.diagram.expressions.SpecializationmodelAbstractExpression RelationSelected_4003_SourceExpression;

		/**
		 * @generated
		 */
		public static boolean canCreateRelationFG_4001(
				specializationModel.Project container,
				specializationModel.Node source, specializationModel.Node target) {
			return canExistRelationFG_4001(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateRelationFeature_4002(
				specializationModel.Project container,
				specializationModel.Feature source,
				specializationModel.Feature target) {
			return canExistRelationFeature_4002(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateRelationSelected_4003(
				specializationModel.Project container,
				specializationModel.Feature source,
				specializationModel.Feature target) {
			return canExistRelationSelected_4003(container, source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistRelationFG_4001(
				specializationModel.Project container,
				specializationModel.Node source, specializationModel.Node target) {
		 ...
		 * @generated
		 */
		public static boolean canExistRelationFeature_4002(
				specializationModel.Project container,
				specializationModel.Feature source,
				specializationModel.Feature target) {
			try {
				...
				if (RelationFeature_4002_SourceExpression == null) {
					Map<String, EClass> env = Collections
							.singletonMap(
									OPPOSITE_END_VAR,
									specializationModel.SpecializationModelPackage.eINSTANCE
											.getFeature());
					RelationFeature_4002_SourceExpression = specializationModel.diagram.expressions.SpecializationmodelOCLFactory
							.getExpression(
									"self <> oppositeEnd", specializationModel.SpecializationModelPackage.eINSTANCE.getFeature(), env); //$NON-NLS-1$
				}
				Object sourceVal = RelationFeature_4002_SourceExpression
		 ...
		 * @generated
		 */
		public static boolean canExistRelationSelected_4003(
				specializationModel.Project container,
				specializationModel.Feature source,
				specializationModel.Feature target) {
			try {
				...
				if (RelationSelected_4003_SourceExpression == null) {
					Map<String, EClass> env = Collections
							.singletonMap(
									OPPOSITE_END_VAR,
									specializationModel.SpecializationModelPackage.eINSTANCE
											.getFeature());
					RelationSelected_4003_SourceExpression = specializationModel.diagram.expressions.SpecializationmodelOCLFactory
							.getExpression(
									"self <> oppositeEnd", specializationModel.SpecializationModelPackage.eINSTANCE.getFeature(), env); //$NON-NLS-1$
				}
				Object sourceVal = RelationSelected_4003_SourceExpression
						.evaluate(source, Collections.singletonMap(
								OPPOSITE_END_VAR, target));
				if (false == sourceVal instanceof Boolean
						|| !((Boolean) sourceVal).booleanValue()) {
