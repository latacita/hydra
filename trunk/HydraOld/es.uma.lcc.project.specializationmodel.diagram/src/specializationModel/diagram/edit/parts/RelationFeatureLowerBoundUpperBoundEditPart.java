 ...
 * @generated
 */
public class RelationFeatureLowerBoundUpperBoundEditPart extends LabelEditPart
	 ...
	 * @generated
	 */
	public RelationFeatureLowerBoundUpperBoundEditPart(View view) {
		super(view);
	}
	...
	private void updateVisibility() {
		NodeImpl myModel = (NodeImpl) this.getModel();
		RelationFeature myObject = (RelationFeature) myModel.getElement();
		boolean vis = false;
		if (myObject.getType() == FeatureType.SIMPLE)
			vis = true;
