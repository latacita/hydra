 ...
 * @generated
 */
public class FeatureGroupLowerBoundUpperBoundEditPart extends LabelEditPart
	 ...
	 * @generated
	 */
	public FeatureGroupLowerBoundUpperBoundEditPart(View view) {
		super(view);
	}
	...
	private void updateVisibility() {
		...
		FeatureGroup myObject = (FeatureGroup) myModel.getElement();
		boolean vis = false;
		if (myObject.getType() == FeatureGroupType.SIMPLEGROUP)
			vis = true;
