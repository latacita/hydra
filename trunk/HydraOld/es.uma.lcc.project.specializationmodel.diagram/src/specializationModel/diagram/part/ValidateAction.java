...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPartDescriptor workbenchPartDescriptor) {
		...
		setText(specializationModel.diagram.part.Messages.ValidateActionMessage);
	...
	public static void runValidation(View view) {
		try {
			if (specializationModel.diagram.part.SpecializationmodelDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		specializationModel.diagram.providers.SpecializationmodelValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			specializationModel.diagram.providers.SpecializationmodelMarkerNavigationProvider
		...
		if (view.isSetElement() && view.getElement() != null) {
			...
			((Project) ((View) diagramEditPart.getModel()).getElement())
					.setValidatedOK(status.isOK());
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		specializationModel.diagram.part.SpecializationmodelDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new specializationModel.diagram.part.SpecializationmodelDiagramEditorUtil.LazyElement2ViewMap(
		...
		for (Iterator<IStatus> it = allStatuses.iterator(); it.hasNext();) {
			...
			View view = specializationModel.diagram.part.SpecializationmodelDiagramEditorUtil
