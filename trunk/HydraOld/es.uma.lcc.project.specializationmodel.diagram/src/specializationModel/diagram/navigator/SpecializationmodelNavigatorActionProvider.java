 ...
 * @generated
 */
public class SpecializationmodelNavigatorActionProvider extends
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					specializationModel.diagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof specializationModel.diagram.navigator.SpecializationmodelNavigatorItem) {
					selectedElement = ((specializationModel.diagram.navigator.SpecializationmodelNavigatorItem) selectedElement)
							.getView();
