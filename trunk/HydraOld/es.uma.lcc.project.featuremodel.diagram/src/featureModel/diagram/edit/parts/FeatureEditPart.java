...
public class FeatureEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new featureModel.diagram.edit.policies.FeatureItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof featureModel.diagram.edit.parts.FeatureNameEditPart) {
			((featureModel.diagram.edit.parts.FeatureNameEditPart) childEditPart)
	...
	protected void handleNotificationEvent(Notification event) {
		if (event.getNotifier() instanceof Feature) {
