 ...
 * <ul>
 *   <li>{@link syntax.impl.BoolPriorityOperand1Impl#getBoolPriorityOp1 <em>Bool Priority Op1</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoolPriorityOperand1Impl extends EObjectImpl implements BoolPriorityOperand1 {
	...
	protected EClass eStaticClass() {
		return SyntaxPackage.Literals.BOOL_PRIORITY_OPERAND1;
	}
	...
	public NotificationChain basicSetBoolPriorityOp1(BoolOperand newBoolPriorityOp1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.BOOL_PRIORITY_OPERAND1__BOOL_PRIORITY_OP1, oldBoolPriorityOp1, newBoolPriorityOp1);
	...
	public void setBoolPriorityOp1(BoolOperand newBoolPriorityOp1) {
		if (newBoolPriorityOp1 != boolPriorityOp1) {
			...
			if (boolPriorityOp1 != null)
				msgs = ((InternalEObject)boolPriorityOp1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.BOOL_PRIORITY_OPERAND1__BOOL_PRIORITY_OP1, null, msgs);
			if (newBoolPriorityOp1 != null)
				msgs = ((InternalEObject)newBoolPriorityOp1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.BOOL_PRIORITY_OPERAND1__BOOL_PRIORITY_OP1, null, msgs);
			msgs = basicSetBoolPriorityOp1(newBoolPriorityOp1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.BOOL_PRIORITY_OPERAND1__BOOL_PRIORITY_OP1, newBoolPriorityOp1, newBoolPriorityOp1));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SyntaxPackage.BOOL_PRIORITY_OPERAND1__BOOL_PRIORITY_OP1:
