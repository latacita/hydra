 ...
 * <ul>
 *   <li>{@link syntax.impl.BinaryOpImpl#getBinaryOp1 <em>Binary Op1</em>}</li>
 *   <li>{@link syntax.impl.BinaryOpImpl#getBinaryOp2 <em>Binary Op2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class BinaryOpImpl extends LogicalOperatorImpl implements BinaryOp {
	...
	protected EClass eStaticClass() {
		return SyntaxPackage.Literals.BINARY_OP;
	}
	...
	public NotificationChain basicSetBinaryOp1(BoolPriorityOperand1 newBinaryOp1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.BINARY_OP__BINARY_OP1, oldBinaryOp1, newBinaryOp1);
	...
	public void setBinaryOp1(BoolPriorityOperand1 newBinaryOp1) {
		if (newBinaryOp1 != binaryOp1) {
			...
			if (binaryOp1 != null)
				msgs = ((InternalEObject)binaryOp1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.BINARY_OP__BINARY_OP1, null, msgs);
			if (newBinaryOp1 != null)
				msgs = ((InternalEObject)newBinaryOp1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.BINARY_OP__BINARY_OP1, null, msgs);
			msgs = basicSetBinaryOp1(newBinaryOp1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.BINARY_OP__BINARY_OP1, newBinaryOp1, newBinaryOp1));
	}
	...
	public NotificationChain basicSetBinaryOp2(BoolPriorityOperand2 newBinaryOp2, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.BINARY_OP__BINARY_OP2, oldBinaryOp2, newBinaryOp2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBinaryOp2(BoolPriorityOperand2 newBinaryOp2) {
		if (newBinaryOp2 != binaryOp2) {
			NotificationChain msgs = null;
			if (binaryOp2 != null)
				msgs = ((InternalEObject)binaryOp2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.BINARY_OP__BINARY_OP2, null, msgs);
			if (newBinaryOp2 != null)
				msgs = ((InternalEObject)newBinaryOp2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.BINARY_OP__BINARY_OP2, null, msgs);
			msgs = basicSetBinaryOp2(newBinaryOp2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.BINARY_OP__BINARY_OP2, newBinaryOp2, newBinaryOp2));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SyntaxPackage.BINARY_OP__BINARY_OP1:
				return basicSetBinaryOp1(null, msgs);
			case SyntaxPackage.BINARY_OP__BINARY_OP2:
