 ...
 * <ul>
 *   <li>{@link syntax.impl.ComparisonImpl#getCompOp1 <em>Comp Op1</em>}</li>
 *   <li>{@link syntax.impl.ComparisonImpl#getCompOp2 <em>Comp Op2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ComparisonImpl extends LogicalOperatorImpl implements Comparison {
	...
	protected EClass eStaticClass() {
		return SyntaxPackage.Literals.COMPARISON;
	}
	...
	public NotificationChain basicSetCompOp1(NumPriorityOperand2 newCompOp1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.COMPARISON__COMP_OP1, oldCompOp1, newCompOp1);
	...
	public void setCompOp1(NumPriorityOperand2 newCompOp1) {
		if (newCompOp1 != compOp1) {
			...
			if (compOp1 != null)
				msgs = ((InternalEObject)compOp1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.COMPARISON__COMP_OP1, null, msgs);
			if (newCompOp1 != null)
				msgs = ((InternalEObject)newCompOp1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.COMPARISON__COMP_OP1, null, msgs);
			msgs = basicSetCompOp1(newCompOp1, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.COMPARISON__COMP_OP1, newCompOp1, newCompOp1));
	}
	...
	public NotificationChain basicSetCompOp2(NumPriorityOperand2 newCompOp2, NotificationChain msgs) {
		...
		compOp2 = newCompOp2;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SyntaxPackage.COMPARISON__COMP_OP2, oldCompOp2, newCompOp2);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCompOp2(NumPriorityOperand2 newCompOp2) {
		if (newCompOp2 != compOp2) {
			NotificationChain msgs = null;
			if (compOp2 != null)
				msgs = ((InternalEObject)compOp2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.COMPARISON__COMP_OP2, null, msgs);
			if (newCompOp2 != null)
				msgs = ((InternalEObject)newCompOp2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SyntaxPackage.COMPARISON__COMP_OP2, null, msgs);
			msgs = basicSetCompOp2(newCompOp2, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyntaxPackage.COMPARISON__COMP_OP2, newCompOp2, newCompOp2));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SyntaxPackage.COMPARISON__COMP_OP1:
				return basicSetCompOp1(null, msgs);
			case SyntaxPackage.COMPARISON__COMP_OP2:
