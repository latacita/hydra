 ...
 */
public class ConstraintImageProvider {
	
	public final static ConstraintImageProvider INSTANCE = new ConstraintImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(syntax.resource.constraint.ui.ConstraintUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				syntax.resource.constraint.ui.ConstraintUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
