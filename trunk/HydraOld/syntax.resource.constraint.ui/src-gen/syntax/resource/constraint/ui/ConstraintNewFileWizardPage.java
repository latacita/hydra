 ...
 */
public class ConstraintNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public ConstraintNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new constraint file");
