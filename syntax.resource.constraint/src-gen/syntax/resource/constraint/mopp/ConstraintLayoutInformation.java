...
/**
 * A ConstraintLayoutInformation is used to store layout information that is found
 ...
 * ConstraintLayoutInformations are aggregated in LayoutInformationAdapters. One
 * ConstraintLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 */
public class ConstraintLayoutInformation {
	
	private final syntax.resource.constraint.grammar.ConstraintSyntaxElement syntaxElement;
	...
	public ConstraintLayoutInformation(syntax.resource.constraint.grammar.ConstraintSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public syntax.resource.constraint.grammar.ConstraintSyntaxElement getSyntaxElement() {
