 ...
 */
public class ConstraintResourceUtil {
	...
	public static syntax.resource.constraint.mopp.ConstraintResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (syntax.resource.constraint.mopp.ConstraintResource) csResource;
	}
	
	public static syntax.resource.constraint.mopp.ConstraintResource getResource(java.io.File file) {
	...
	public static syntax.resource.constraint.mopp.ConstraintResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new syntax.resource.constraint.mopp.ConstraintMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (syntax.resource.constraint.mopp.ConstraintResource) resource;
	}
	
	/**
	 * Returns the root element of the resource with the given URI.
	 */
	public static syntax.Model getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static syntax.Model getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
