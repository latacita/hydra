 ...
 * to 4 bytes).
 */
public class ConstraintUnicodeConverter extends syntax.resource.constraint.mopp.ConstraintInputStreamProcessor {
	 ...
	 */
	public ConstraintUnicodeConverter(java.io.InputStream inputStream) {
