 ...
 * delegates.
 */
public class ConstraintLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends syntax.resource.constraint.util.AbstractConstraintInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, syntax.resource.constraint.util.AbstractConstraintInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final syntax.resource.constraint.debug.ConstraintDebuggableInterpreter<ResultType, ContextType> interpreter = new syntax.resource.constraint.debug.ConstraintDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		syntax.resource.constraint.debug.ConstraintDebuggerListener<ResultType, ContextType> debugListener = new syntax.resource.constraint.debug.ConstraintDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		syntax.resource.constraint.debug.ConstraintDebugProcess process = new syntax.resource.constraint.debug.ConstraintDebugProcess(launch);
		launch.addDebugTarget(new syntax.resource.constraint.debug.ConstraintDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(syntax.resource.constraint.launch.ConstraintLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return syntax.resource.constraint.util.ConstraintResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, syntax.resource.constraint.mopp.ConstraintPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
