 ...
 * olInput</code>.
 */
public class ConstraintDocBrowserInformationControlInput {
	
	private final ConstraintDocBrowserInformationControlInput fPrevious;
	private ConstraintDocBrowserInformationControlInput fNext;
	 ...
	 */
	public ConstraintDocBrowserInformationControlInput(ConstraintDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public ConstraintDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public ConstraintDocBrowserInformationControlInput getNext() {
		return fNext;
	}
