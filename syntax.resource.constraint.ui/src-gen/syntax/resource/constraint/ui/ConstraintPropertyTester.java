...
public class ConstraintPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new syntax.resource.constraint.mopp.ConstraintMetaInformation().getSyntaxName());
	}
