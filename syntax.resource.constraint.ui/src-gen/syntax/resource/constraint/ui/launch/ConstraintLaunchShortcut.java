 ...
 */
public class ConstraintLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new syntax.resource.constraint.mopp.ConstraintMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(syntax.resource.constraint.launch.ConstraintLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			syntax.resource.constraint.mopp.ConstraintPlugin.logError("Exception while launching selection", e);
		}
	}
