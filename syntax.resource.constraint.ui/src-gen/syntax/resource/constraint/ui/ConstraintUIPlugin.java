 ...
 */
public class ConstraintUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "syntax.resource.constraint.ui";
	public static final String EDITOR_ID = "syntax.resource.constraint.ui.ConstraintEditor";
	...
	private static ConstraintUIPlugin plugin;
	
	public ConstraintUIPlugin() {
		super();
	}
	...
	public static ConstraintUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ConstraintUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, ConstraintUIPlugin.PLUGIN_ID, message);
		}
		final ConstraintUIPlugin pluginInstance = ConstraintUIPlugin.getDefault();
