 ...
 */
public class ConstraintNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new syntax.resource.constraint.mopp.ConstraintMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public ConstraintNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("syntax.resource.constraint.ui");
							...
							String natureID = syntax.resource.constraint.mopp.ConstraintNature.NATURE_ID;
							...
							for (String builderID : syntax.resource.constraint.mopp.ConstraintNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								syntax.resource.constraint.mopp.ConstraintMetaInformation info = new syntax.resource.constraint.mopp.ConstraintMetaInformation();
