 ...
 */
public class ConstraintTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private syntax.resource.constraint.IConstraintHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final syntax.resource.constraint.ui.ConstraintBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(syntax.resource.constraint.ui.ConstraintBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput infoInput = (syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					syntax.resource.constraint.ui.ConstraintHyperlink hyperlink = new syntax.resource.constraint.ui.ConstraintHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (syntax.resource.constraint.ui.ConstraintBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				syntax.resource.constraint.ui.ConstraintBrowserInformationControl iControl = new syntax.resource.constraint.ui.ConstraintBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput) {
							syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput input = (syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (syntax.resource.constraint.ui.ConstraintBrowserInformationControl.isAvailable(parent)) {
				syntax.resource.constraint.ui.ConstraintBrowserInformationControl iControl = new syntax.resource.constraint.ui.ConstraintBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public ConstraintTextHover(syntax.resource.constraint.IConstraintResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new syntax.resource.constraint.ui.ConstraintUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		syntax.resource.constraint.IConstraintTextResource textResource = resourceProvider.getResource();
	 ...
	 */
	private syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				syntax.resource.constraint.ui.ConstraintHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			syntax.resource.constraint.ui.ConstraintHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			syntax.resource.constraint.ui.ConstraintHTMLPrinter.insertPageProlog(buffer, 0, syntax.resource.constraint.ui.ConstraintTextHover.getStyleSheet());
			syntax.resource.constraint.ui.ConstraintHTMLPrinter.addPageEpilog(buffer);
			return new syntax.resource.constraint.ui.ConstraintDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = syntax.resource.constraint.ui.ConstraintHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(syntax.resource.constraint.ui.ConstraintUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return syntax.resource.constraint.util.ConstraintStreamUtil.getContent(styleSheetURL.openStream());
