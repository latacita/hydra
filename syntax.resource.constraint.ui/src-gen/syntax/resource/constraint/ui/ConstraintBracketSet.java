 ...
 */
public class ConstraintBracketSet {
	...
	private java.util.ArrayList<syntax.resource.constraint.IConstraintBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements syntax.resource.constraint.IConstraintBracketPair {
	 ...
	 */
	private class ClosingListener implements syntax.resource.constraint.ui.IConstraintBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				syntax.resource.constraint.IConstraintBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public ConstraintBracketSet(syntax.resource.constraint.ui.ConstraintEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new syntax.resource.constraint.mopp.ConstraintMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<syntax.resource.constraint.IConstraintBracketPair>();
	 ...
	 */
	public syntax.resource.constraint.IConstraintBracketPair getBracketPair(String opening, String closing) {
		for (syntax.resource.constraint.IConstraintBracketPair bracketPair : bracketPairs) {
	...
	public syntax.resource.constraint.IConstraintBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(syntax.resource.constraint.IConstraintBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + syntax.resource.constraint.ui.ConstraintPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public syntax.resource.constraint.IConstraintBracketPair remove(String opening, String closing) {
		for (syntax.resource.constraint.IConstraintBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<syntax.resource.constraint.IConstraintBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, syntax.resource.constraint.ui.ConstraintPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, syntax.resource.constraint.ui.ConstraintPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
