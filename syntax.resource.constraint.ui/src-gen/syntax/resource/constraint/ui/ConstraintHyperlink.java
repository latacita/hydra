 ...
 */
public class ConstraintHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public ConstraintHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				syntax.resource.constraint.mopp.ConstraintPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
