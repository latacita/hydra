...
/**
 * A text editor for 'constraint' models.
 */
public class ConstraintEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, syntax.resource.constraint.IConstraintResourceProvider, syntax.resource.constraint.ui.IConstraintBracketHandlerProvider, syntax.resource.constraint.ui.IConstraintAnnotationModelProvider {
	
	private syntax.resource.constraint.ui.ConstraintHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private syntax.resource.constraint.ui.ConstraintCodeFoldingManager codeFoldingManager;
	private syntax.resource.constraint.ui.ConstraintBackgroundParsingStrategy bgParsingStrategy = new syntax.resource.constraint.ui.ConstraintBackgroundParsingStrategy();
	private java.util.Collection<syntax.resource.constraint.IConstraintBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<syntax.resource.constraint.IConstraintBackgroundParsingListener>();
	private syntax.resource.constraint.ui.ConstraintColorManager colorManager = new syntax.resource.constraint.ui.ConstraintColorManager();
	private syntax.resource.constraint.ui.ConstraintOutlinePage outlinePage;
	...
	private syntax.resource.constraint.ui.ConstraintPropertySheetPage propertySheetPage;
	...
	private syntax.resource.constraint.ui.IConstraintBracketHandler bracketHandler;
	...
	public ConstraintEditor() {
		super();
		setSourceViewerConfiguration(new syntax.resource.constraint.ui.ConstraintEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), ConstraintEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								syntax.resource.constraint.IConstraintTextResource currentResource = getResource();
				...
				syntax.resource.constraint.ui.ConstraintUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("syntax.resource.constraint.EditorContext");
		setRulerContextMenuId("syntax.resource.constraint.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new syntax.resource.constraint.ui.ConstraintHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new syntax.resource.constraint.ui.ConstraintCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		syntax.resource.constraint.mopp.ConstraintNature.activate(inputFile.getProject());
		...
		syntax.resource.constraint.IConstraintTextResource loadedResource = (syntax.resource.constraint.IConstraintTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				syntax.resource.constraint.IConstraintTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof syntax.resource.constraint.IConstraintTextResource) {
					setResource((syntax.resource.constraint.IConstraintTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					syntax.resource.constraint.ui.ConstraintUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the ConstraintEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				syntax.resource.constraint.ui.ConstraintUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(syntax.resource.constraint.IConstraintTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new syntax.resource.constraint.ui.ConstraintOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new syntax.resource.constraint.ui.ConstraintPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			syntax.resource.constraint.IConstraintTextResource textResource = (syntax.resource.constraint.IConstraintTextResource) element.eResource();
			...
			syntax.resource.constraint.IConstraintTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				syntax.resource.constraint.IConstraintTextToken token = lexer.getNextToken();
			...
			syntax.resource.constraint.ui.ConstraintUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!ConstraintEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(syntax.resource.constraint.IConstraintBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (syntax.resource.constraint.IConstraintBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public syntax.resource.constraint.ui.IConstraintBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(syntax.resource.constraint.ui.IConstraintBracketHandler bracketHandler) {
