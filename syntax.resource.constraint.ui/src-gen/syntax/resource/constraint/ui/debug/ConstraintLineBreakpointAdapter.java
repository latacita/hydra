...
public class ConstraintLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(syntax.resource.constraint.mopp.ConstraintPlugin.DEBUG_MODEL_ID);
			...
			syntax.resource.constraint.debug.ConstraintLineBreakpoint lineBreakpoint = new syntax.resource.constraint.debug.ConstraintLineBreakpoint(resource, lineNumber + 1);
