 ...
 * 
 */
package syntax.resource.constraint.ui.debug;

@SuppressWarnings("restriction")
public class ConstraintAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new syntax.resource.constraint.mopp.ConstraintMetaInformation().getSyntaxName())) {
					return new syntax.resource.constraint.ui.debug.ConstraintLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof syntax.resource.constraint.debug.ConstraintDebugVariable) {
			final syntax.resource.constraint.debug.ConstraintDebugVariable variable = (syntax.resource.constraint.debug.ConstraintDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof syntax.resource.constraint.debug.ConstraintDebugVariable) {
			final syntax.resource.constraint.debug.ConstraintDebugVariable variable = (syntax.resource.constraint.debug.ConstraintDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							syntax.resource.constraint.debug.ConstraintDebugValue castedValue = (syntax.resource.constraint.debug.ConstraintDebugValue) value;
