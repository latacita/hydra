 ...
 * a specified depth.
 */
public class ConstraintOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public ConstraintOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof syntax.resource.constraint.ui.ConstraintEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			syntax.resource.constraint.mopp.ConstraintPlugin.logError("Exception while refreshing outline view", e);
		}
	}
