...
public class ConstraintNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private syntax.resource.constraint.ui.ConstraintNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public ConstraintNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new syntax.resource.constraint.ui.ConstraintNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			syntax.resource.constraint.ui.ConstraintUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			syntax.resource.constraint.ui.ConstraintUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new syntax.resource.constraint.mopp.ConstraintMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new syntax.resource.constraint.mopp.ConstraintMetaInformation().getSyntaxName();
	}
